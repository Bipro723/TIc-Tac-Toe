...
{
    blocks[i].addEventListener("click", game, {once:true}); //Permette di essere cliccato solo 1 volta
}
...
function game()
{
    ...
    {
        this.innerHTML = "X";   
        //aggiungo la proprietà 'own' per assegnare la casella al giocatore
        this.own = "x";
